    ...
    <Dialog isOpen={isOpen} onClose={onClose}>
      <div className="size-full">
        <div className="mb-[16px] flex w-full flex-row justify-center">
          <img className="object-contain" decoding="async" height={36} src="/public/arema.svg" width={98} />
        </div>
        ...
        <img alt="" className="mb-[24px] w-full" decoding="async" src={FeatureExplainImageUrl} />
